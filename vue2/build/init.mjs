...
if (config.build === 'webpack') {
  ...
  if (config.single === 'true') {
    ...
    fs.copy('build/vite/index.single.html', 'public/index.html')
  } else {
    // 拷贝多页文件
    ...
    fs.copy('build/views/list', 'src/views/list')
    fs.copy('build/vite/index.multi.html', 'public/index.html')
    fs.copy('build/vite/list.html', 'public/list.html')
  }
}
